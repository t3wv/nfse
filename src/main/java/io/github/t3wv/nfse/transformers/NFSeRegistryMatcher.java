...
public class NFSeRegistryMatcher extends RegistryMatcher {
    public NFSeRegistryMatcher() {
        ...
        super.bind(NFSeSefinNacionalValoresNFSeTipoBeneficioMunicipal.class, new NFSeSefinNacionalValoresNFSeTipoBeneficioMunicipalTransformer());
        ...
        super.bind(NFSeSefinNacionalTSMotivoEmisTI.class, new NFSeSefinNacionalTSMotivoEmisTITransformer());
        super.bind(NFSeSefinNacionalTSCodMotivoRejeicao.class, new NFSeSefinNacionalTSCodMotivoRejeicaoTransformer());
