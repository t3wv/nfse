...
public class NFSeBarueriRPSArquivoEnvioRegistroTipo4 extends NFSeBarueriRPSArquivoEnvioRegistro<NFSeBarueriRPSArquivoEnvioRegistroTipo4> {
    ...
    public String toLinha() {
        return String.format("%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s",
                ...
                trataString(this.regimeApuracaoTributariaSimplesNacional != null ? this.regimeApuracaoTributariaSimplesNacional.getCodigo() : null, 1),
                trataString(this.paisLocalServicoPrestado != null ? this.paisLocalServicoPrestado.getCodigo() : null, 3),
                this.codigoCidadeLocalServicoPrestado != null ? trataNumerico(this.codigoCidadeLocalServicoPrestado, 7) : trataString("" , 7),
                this.codigoCidadeTomador != null ? trataNumerico(this.codigoCidadeTomador, 7) : trataString(null, 7),
                trataString(this.nif, 40),
                trataString(this.codigoNBS, 9),
                trataString(this.codigoPostalTomadorEstrangeiro, 11),
                trataString(this.estadoProvinciaRegiaoTomadorEstrangeiro, 60),
                this.vinculoEntrePartes != null ? this.vinculoEntrePartes.getCodigo() : " ",
                trataString(this.reservado, 30),
                trataString(this.codigoPostalLocalServicoPrestadoExterior, 11),
                trataString(this.estadoProvinciaRegiaoLocalServicoPrestadoExterior, 60),
                trataString(this.nomeDoEvento, 255),
                trataString(this.dataInicioEvento != null ? this.dataInicioEvento.format(WSBarueri.FORMATO_DATA) : "", 8),
                trataString(this.dataTerminoEvento != null ? this.dataTerminoEvento.format(WSBarueri.FORMATO_DATA) : "", 8),
                trataString(this.justificativaCancelamento != null ? this.justificativaCancelamento.getCodigo() : null, 1),
                trataString(this.codigoIndicadorOperacaoFornecimento, 6),
                trataString(this.codigoClassificacaoTributariaIBSCBS, 6),
                trataString(this.codigoSituacaoTributariaIBSCBS, 3),
