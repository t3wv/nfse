...
public class NFSeBarueriRPSArquivoEnvioRegistroTipo5 extends NFSeBarueriRPSArquivoEnvioRegistro<NFSeBarueriRPSArquivoEnvioRegistroTipo5> {
    ...
    public String toLinha() {
        return String.format("%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s",
                getTipoRegistro(),
                trataNumerico(this.codigoClassificacaoCreditoPresumidoIBSCBS, 2),
                trataNumerico(this.tipoEnteGovernamentalParaAquisicaoServicoPelaAdministracaoPublica != null ? this.tipoEnteGovernamentalParaAquisicaoServicoPelaAdministracaoPublica.getCodigo() : "", 1),
                trataNumerico(this.tipoOperacaoEnteGovernamentalOuSobreBensImoveis != null ? this.tipoOperacaoEnteGovernamentalOuSobreBensImoveis.getCodigo() : "", 1),
                trataNumerico(this.chaveNFSeReferenciada, 50),
                trataNumerico(this.codigoNCM, 8),
                trataString(this.descricaoBemMovelObjetoLocacao, 150),
                trataNumerico(this.quantidadeBemMovelObjetoLocacao , 3),
                trataNumerico(this.indicadorOperacaoDoacao != null ? this.indicadorOperacaoDoacao.getCodigo() : "", 1),
                trataNumerico(this.destinatarioServicoEstrangeiro != null && this.destinatarioServicoEstrangeiro ? "1" : "2", 1),
                trataNumerico(this.cpfCnpjDestinatarioServico, 14),
                ...
                this.enderecoCodigoCidadeDestinatarioServico != null ? trataNumerico(this.enderecoCodigoCidadeDestinatarioServico, 7) : trataString(null, 7), // Semelhante ao que é feito no registro 2 apesar de não fazer sentido com a tipagem da documentação
                ...
                trataNumerico(this.enderecoCEPDestinatarioServico, 8),
