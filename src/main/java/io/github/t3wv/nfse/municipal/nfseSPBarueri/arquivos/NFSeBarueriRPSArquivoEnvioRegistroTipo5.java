...
public class NFSeBarueriRPSArquivoEnvioRegistroTipo5 extends NFSeBarueriRPSArquivoEnvioRegistro<NFSeBarueriRPSArquivoEnvioRegistroTipo5> {
    ...
    public String toLinha() {
        return String.format("%s",
                getTipoRegistro(),
                StringUtils.rightPad(StringUtils.defaultString(this.codigoClassificacaoCreditoPresumidoIBSCBS), 2),
                StringUtils.rightPad(this.tipoEnteGovernamentalParaAquisicaoServicoPelaAdministracaoPublica != null ? this.tipoEnteGovernamentalParaAquisicaoServicoPelaAdministracaoPublica.getCodigo() : "", 1),
                StringUtils.rightPad(this.tipoOperacaoEnteGovernamentalOuSobreBensImoveis != null ? this.tipoOperacaoEnteGovernamentalOuSobreBensImoveis.getCodigo() : "", 1),
                StringUtils.rightPad(StringUtils.defaultString(this.chaveNFSeReferenciada), 50),
                StringUtils.rightPad(StringUtils.defaultString(this.codigoNCM), 8),
                StringUtils.rightPad(StringUtils.defaultString(this.descricaoBemMovelObjetoLocacao), 150),
                StringUtils.leftPad(this.quantidadeBemMovelObjetoLocacao != null ? String.valueOf(this.quantidadeBemMovelObjetoLocacao) : "0", 3, "0"),
                StringUtils.rightPad(this.indicadorOperacaoDoacao != null ? this.indicadorOperacaoDoacao.getCodigo() : "", 1),
                destinatarioServicoEstrangeiro != null && destinatarioServicoEstrangeiro ? "1" : "0",
                StringUtils.rightPad(StringUtils.defaultString(this.cpfCnpjDestinatarioServico), 14),
                StringUtils.rightPad(StringUtils.defaultString(this.razaoSocialDestinatarioServico), 60),
                StringUtils.rightPad(StringUtils.defaultString(this.enderecoLogradouroDestinatarioServico), 75),
                StringUtils.rightPad(StringUtils.defaultString(this.enderecoNumeroDestinatarioServico), 9),
                StringUtils.rightPad(StringUtils.defaultString(this.enderecoComplementoDestinatarioServico), 30),
                StringUtils.rightPad(StringUtils.defaultString(this.enderecoBairroDestinatarioServico), 40),
                StringUtils.rightPad(StringUtils.defaultString(this.enderecoCidadeDestinatarioServico), 40),
                StringUtils.rightPad(StringUtils.defaultString(this.enderecoCodigoCidadeDestinatarioServico), 7),
                StringUtils.rightPad(StringUtils.defaultString(this.enderecoUFDestinatarioServico), 2),
                StringUtils.rightPad(this.enderecoPaisDestinatarioServico != null ? this.enderecoPaisDestinatarioServico.getCodigo() : "", 3),
                StringUtils.rightPad(StringUtils.defaultString(this.enderecoCEPDestinatarioServico), 8),
                StringUtils.rightPad(StringUtils.defaultString(this.emailDestinatarioServico), 80),
                StringUtils.rightPad(StringUtils.defaultString(this.nifDestinatarioServico), 40),
                StringUtils.rightPad(StringUtils.defaultString(this.codigoEnderecoPostalDestinatarioEstrangeiro), 11),
                StringUtils.rightPad(StringUtils.defaultString(this.estadoProvinciaRegiaoDestinatarioEstrangeiro), 60)
        );
    }
}
